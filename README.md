...
SCREAMRRRR is an open-source, Discord-native community security and incident-response sentinel.
...
SCREAMRRRR is pre-alpha. Interfaces, policy schema, and detectors may change before the first tagged release.
